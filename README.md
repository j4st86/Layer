...
Нужны JDK 17, Android SDK 36, Go 1.25+ и NDK 28. Скрипт собирает slim sing-box **v1.14.1** (TUN, VLESS, Reality/uTLS, gVisor), без QUIC, WireGuard, Tailscale и Naive. Версия ядра и патчи задаются в `sing-box.properties` и `scripts/libbox/patches`.
