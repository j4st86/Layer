...
You need JDK 17, Android SDK 37 (compile) / 36 (target), Go 1.25+, and NDK 28. The script builds slim sing-box **v1.14.0** (TUN, VLESS, Reality/uTLS, gVisor), without QUIC, WireGuard, Tailscale, or Naive.
